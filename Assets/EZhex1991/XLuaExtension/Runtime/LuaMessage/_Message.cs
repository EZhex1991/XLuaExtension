...
namespace EZhex1991.XLuaExtension
{
    ...
    {
        /* 用法示例：
         * local message = CS.EZhex1991.XLuaExtension.UpdateMessage.Require(gameOject)    -- 获取
         * message.update:AddAction(func)   -- 添加
         * message.fixedUpdate:RemoveAction(func)   -- 移除
         * message.lateUpdate:Clear()   -- 清空
         * message:Dismiss()    -- 销毁，或者CS.EZhex1991.XLuaExtension.UpdateMessage.Dismiss(gameOject)
         */
